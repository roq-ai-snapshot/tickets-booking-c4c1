  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of event planning with Tickets Booking Application. Quick downloads, unbeatable offers, and unparalleled convenience at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1578575436955-ef29da568c6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0aWNrZXRzfGVufDB8fHx8MTY5ODI0NTI0NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@andylid0?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Andy Li`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of event planning with Tickets Booking Application. Quick downloads, unbeatable offers, and unparalleled convenience at your fingertips.`}
            </Text>
            <Box
