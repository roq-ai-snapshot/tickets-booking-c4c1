        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.available_tickets,
            }}
            name="available_tickets"
            error={formik.errors?.available_tickets}
            value={formik.values?.available_tickets}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('available_tickets', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
